...
pub const ACHIEVEMENT_FIRST_SOLVE: u8 = 0;
pub const ACHIEVEMENT_NO_UNDO: u8 = 1;
pub const ACHIEVEMENT_SPEED_DEMON: u8 = 2;
pub const ACHIEVEMENT_HARD_SOLVER: u8 = 3;
pub const ACHIEVEMENT_CENTURION: u8 = 4;
